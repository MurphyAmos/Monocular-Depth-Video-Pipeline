...
* **Preview On By Default.** Preview On By Default. Live preview via cv2.imshow is available through the preview flag, currently enabled by default so you can see the depth map as it's generated, keeping off runs faster.
